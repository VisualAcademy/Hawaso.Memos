...
namespace Hawaso.Models
{
    ...
    /// InquiryBase, ArticleBase, PostBase, EntryBase, ...
    ...
    /// <summary>
    /// [1] Model Class: Inquiry 모델 클래스 == Inquiries 테이블과 일대일로 매핑
    /// Inquiry, InquiryModel, InquiryViewModel, InquiryDto, InquiryEntity, InquiryObject, ...
    /// </summary>
    [Table("Inquiries")]
    public class Inquiry : InquiryBase
    {
