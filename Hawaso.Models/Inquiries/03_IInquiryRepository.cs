...
namespace Hawaso.Models
{
    ...
    /// </summary>
    //public interface IInquiryCrudRepository<T> : IRepositoryBase<Inquiry, long, long>
    public interface IInquiryCrudRepository<T> : ICrudRepositoryBase<Inquiry, long>
    {
    ...
    /// </summary>
    public interface IInquiryRepository : IInquiryCrudRepository<Inquiry>
    {
        // PM> Install-Package Dul
        Task<ArticleSet<Inquiry, long>> GetByAsync<TParentIdentifier>(FilterOptions<TParentIdentifier> options);
