...
namespace Hawaso.Pages.Inquiries.Components
{
    public partial class ModalForm
    {
        ...
        /// </summary>
        [Parameter]
        public Inquiry ModelSender { get; set; }

        /// <summary>
        /// 전체 넘어온 개체 중에서 폼에서 변경되는 내용만 따로 관리: ModelEdit => InquiryEdit, InquiryViewModel, ...
        /// </summary>
        public Inquiry ModelEdit { get; set; }
        ...
        protected async void CreateOrEditClick()
        {
            ...
            if (selectedFiles != null && selectedFiles.Length > 0)
            {
                ...
                if (file != null)
                {
                    ...
                    await FileStorageManagerReference.UploadAsync(file.Data, file.Name, "Inquiries", true);
