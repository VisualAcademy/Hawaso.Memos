...
namespace Hawaso.Pages.Inquiries
{
    public partial class Create
    {
        ...
        [Inject]
        public IInquiryFileStorageManager FileStorageManagerInjector { get; set; }
        #endregion

        #region Properties
        private Inquiry Model { get; set; } = new Inquiry();
        ...
        protected async void FormSubmit()
        {
            ...
            if (selectedFiles != null && selectedFiles.Length > 0)
            {
                ...
                if (file != null)
                {
                    ...
                    fileName = await FileStorageManagerInjector.UploadAsync(file.Data, file.Name, "Inquiries", true);
            ...
            // Manage 컴포넌트로 이동 
            NavigationManagerInjector.NavigateTo("/Inquiries");
        }
